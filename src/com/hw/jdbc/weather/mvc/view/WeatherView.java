package com.hw.jdbc.weather.mvc.view;

import java.util.InputMismatchException;
import java.util.List;
import java.util.Scanner;

import com.hw.jdbc.weather.mvc.controller.WeatherController;
...
public class WeatherView {
	...
	private void createWeather() {
		...
		String temp = "";
		while(true) {
			System.out.print("추가하실 날씨의 번호를 입력해주세요. >");
			String weatherId = sc.nextLine();
			try {
				wId = Integer.parseInt(weatherId);
				break;
			} catch(NumberFormatException e) {
		...
		WeatherDto weather = new WeatherDto(wId, weatherName, temp, mId);
